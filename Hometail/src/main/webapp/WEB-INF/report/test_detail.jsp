						        ...
						        <tr>
						          <td class="text-left" colspan="2">
						            ...
						            <pre style="white-space: pre-wrap;background-color: white;border:none">${rvo.msg }</pre>
						        			   ...
						        			   <!-- 대댓글폼 hide용		다른거닫고 value값으로 받아온 no의 대댓글만 display시켜주겟다 -->
						       <tr class="rIn" id="rIn${rvo.no }" value="${rvo.no }" style="display:none">
						       <td colspan="2">
						        <form method=post action="../board/reply_reply_insert.do">
						            <input type=hidden name="no" value="${rvo.no }"> <!-- 본게시물 돌아오기용 -->
						            <input type=hidden name="bno" value="${vo.no }"> <!-- 해당 댓글의 값 받아오기 용 -->
